...
This service fixes the issue T480s could when booting causing the backlight to appear even though the kbd_backlight/brightness value is set to 1, forcing the user to manually toggle it
